...
#define LIST_IS_EMPTY(list) ({ list_t* l = ((list_t*) (list)); l->next == l; })
...
#define LIST_CLEAR(list)	({ list_t* l = ((list_t*) (list)); l->next = l->prev = l; })
 ...
 * 
 * @param head the head of the list to return the length of
 * 
