...
static AVLTreeNode* create_node(data_type data) {
    AVLTreeNode* node = (AVLTreeNode*) Calloc(1, sizeof(AVLTreeNode));
    node->data = data;
    return node;
}

static AVLTreeNode* get_node(AVLTree* tree, data_type data) {
...
static AVLTreeNode* get_parent_to_be_node(AVLTree* tree, data_type data) {
    AVLTreeNode* curr_node = tree->root;
    while (1) {
